...
export const RetroAchievementsIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    viewBox="0 0 20 20"
    xmlns="http://www.w3.org/2000/svg"
