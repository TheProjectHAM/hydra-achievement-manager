    ...
    <div>
      <div className="bg-gray-100 dark:bg-white/5 rounded-lg p-4 mb-8">
        <div className="flex justify-between items-center">
          ...
          <span className="text-sm text-gray-900 dark:text-white">{packageJson.version}</span>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <a href="https://github.com/Levynsk/hydra-achievement-manager" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-900 dark:text-white flex items-center gap-2">
            <GithubIcon className="w-4 h-4 text-gray-700 dark:text-gray-300" />
            <span className="truncate">github.com/Levynsk/hydra-achievement-manager</span>
          </a>
        </div>
      </div>
