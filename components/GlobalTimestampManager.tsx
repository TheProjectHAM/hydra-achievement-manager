...
const ModeButton: React.FC<{
  ...
  const activeClasses = 'bg-gray-800 text-white dark:bg-white dark:text-black';
  const inactiveClasses = 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-white/5 dark:text-gray-300 dark:hover:bg-white/10';
  
  return (
    <button
      onClick={onClick}
      className={`flex-1 px-4 h-10 text-sm font-semibold transition-colors ${
