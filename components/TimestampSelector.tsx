...
const ActionButton: React.FC<{
  ...
  <button
    ...
    disabled={disabled}
    className="flex items-center justify-center w-8 h-8 bg-black/5 text-gray-700 hover:bg-black/10 dark:bg-[#1a1a1b] dark:text-gray-400 dark:hover:bg-[#232325] rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-1.5 flex-grow">
          <input
            ...
            disabled={disabled}
            className="w-full bg-gray-200 dark:bg-[#17171a] text-left text-sm text-gray-800 dark:text-gray-300 rounded-md px-2 py-1 h-8 border border-transparent focus:outline-none focus:border-gray-600 transition-colors disabled:bg-gray-100 dark:disabled:bg-[#0a0a0b] disabled:cursor-not-allowed disabled:text-gray-400 dark:disabled:text-gray-600"
          ...
          {timeFormat === '12h' && (
            <button
              ...
              disabled={disabled}
              className="w-12 h-8 flex-shrink-0 flex items-center justify-center bg-gray-200 dark:bg-[#17171a] text-center text-sm font-semibold text-gray-800 dark:text-gray-300 rounded-md border border-transparent focus:outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
