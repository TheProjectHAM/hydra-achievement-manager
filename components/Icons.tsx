...
export const MaximizeIcon: React.FC<IconProps> = ({ className }) => <MaterialIcon className={className} iconName="fullscreen" />;

export const RestoreIcon: React.FC<IconProps> = ({ className }) => <MaterialIcon className={className} iconName="fullscreen_exit" />;
