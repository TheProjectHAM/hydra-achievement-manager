...
fn build_windows_directories() -> Vec<DirectoryConfig> {
    ...
    let app_data = std::env::var("APPDATA").unwrap_or_else(|_| {
        format!("C:/Users/{}/AppData/Roaming", get_windows_username())
    });
    let documents = dirs::document_dir()
        .map(|p| p.to_string_lossy().to_string())
        .unwrap_or_else(|| format!("C:/Users/{}/Documents", get_windows_username()));
    let local_app_data = std::env::var("LOCALAPPDATA").unwrap_or_else(|_| {
        format!("C:/Users/{}/AppData/Local", get_windows_username())
    });
...
fn get_cracker_paths(cracker: crate::models::Cracker) -> Vec<(BasePathVar, String)> {
    ...
    match cracker {
        Cracker::Codex => vec![
            (BasePathVar::PublicDocuments, "Steam/CODEX/<objectId>/achievements.ini".into()),
            (BasePathVar::AppData, "Steam/CODEX/<objectId>/achievements.ini".into()),
        ],
        Cracker::Rune => vec![
            (BasePathVar::PublicDocuments, "Steam/RUNE/<objectId>/achievements.ini".into()),
        ],
        Cracker::OnlineFix => vec![
            (BasePathVar::PublicDocuments, "OnlineFix/<objectId>/Stats/Achievements.ini".into()),
            (BasePathVar::PublicDocuments, "OnlineFix/<objectId>/Achievements.ini".into()),
        ],
        Cracker::Goldberg => vec![
            (BasePathVar::AppData, "Goldberg SteamEmu Saves/<objectId>/achievements.json".into()),
            (BasePathVar::AppData, "GSE Saves/<objectId>/achievements.json".into()),
        ],
        Cracker::Rld => vec![
            (BasePathVar::ProgramData, "RLD!/<objectId>/achievements.ini".into()),
            (BasePathVar::ProgramData, "Steam/Player/<objectId>/stats/achievements.ini".into()),
            (BasePathVar::ProgramData, "Steam/RLD!/<objectId>/stats/achievements.ini".into()),
            (BasePathVar::ProgramData, "Steam/dodi/<objectId>/stats/achievements.ini".into()),
        ],
        Cracker::Empress => vec![
            (BasePathVar::AppData, "EMPRESS/remote/<objectId>/achievements.json".into()),
            (BasePathVar::PublicDocuments, "EMPRESS/<objectId>/remote/<objectId>/achievements.json".into()),
        ],
        Cracker::Skidrow => vec![
            (BasePathVar::Documents, "SKIDROW/<objectId>/SteamEmu/UserStats/achiev.ini".into()),
            (BasePathVar::Documents, "Player/<objectId>/SteamEmu/UserStats/achiev.ini".into()),
            (BasePathVar::LocalAppData, "SKIDROW/<objectId>/SteamEmu/UserStats/achiev.ini".into()),
        ],
        Cracker::CreamApi => vec![
            (BasePathVar::AppData, "CreamAPI/<objectId>/stats/CreamAPI.Achievements.cfg".into()),
        ],
        Cracker::SmartSteamEmu => vec![
            (BasePathVar::AppData, "SmartSteamEmu/<objectId>/User/Achievements.ini".into()),
        ],
        Cracker::Rle => vec![
            (BasePathVar::AppData, "RLE/<objectId>/achievements.ini".into()),
            (BasePathVar::AppData, "RLE/<objectId>/Achievements.ini".into()),
        ],
        Cracker::Razor1911 => vec![
            (BasePathVar::AppData, ".1911/<objectId>/achievement".into()),
        ],
        Cracker::Flt => {
...
fn resolve_windows_base_path(var: &BasePathVar) -> PathBuf {
    match var {
        BasePathVar::AppData => {
            let path = std::env::var("APPDATA").unwrap_or_else(|_| {
                format!("C:/Users/{}/AppData/Roaming", get_windows_username())
            });
            PathBuf::from(path)
        }
        ...
        BasePathVar::LocalAppData => {
            let path = std::env::var("LOCALAPPDATA").unwrap_or_else(|_| {
                format!("C:/Users/{}/AppData/Local", get_windows_username())
            });
            PathBuf::from(path)
        }
